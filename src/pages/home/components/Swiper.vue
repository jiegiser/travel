...
<div class="wrapper">
  <swiper :options="swiperOption" v-if="showSwiper">
    ...
    <!-- <swiper-slide>
        <img class="swiper-img" src="http://mp-piao-admincp.qunarzz.com/mp_piao_admin_mp_piao_admin/admin/20194/e9f92741ef8b1cb0472ced96150d0d1c.jpg_750x200_1f0a2392.jpg" />
    </swiper-slide> -->
